...
public class ItTableConstants {
    ...
    public static final String DB_IT_TABLE = "INFORMATICS";
    ...
    public static final String DB_CREATE_IT_TABLE =
            "CREATE TABLE " + DB_IT_TABLE + "( " +
                    IT_KEY_ID + " " + IT_KEY_ID_OPTIONS + ", " +
                    ...
                    ");";
    public static final String DROP_IT_TABLE =
            "DROP TABLE IF EXISTS " + DB_IT_TABLE;
}
